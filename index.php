...
<head>
	...
	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="vendors/images/layout/taag.png">
	<link rel="icon" type="image/png" sizes="32x32" href="vendors/images/layout/taag.png">
	<link rel="icon" type="image/png" sizes="16x16" href="vendors/images/layout/taag.png">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="vendors/images/layout/loding.png" alt="" with="100%">
				</a>
			</div>
		</div>
	</div>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary"> <span style="color: blue">Welcome To </span>HR Connect !</h2>
						</div>
