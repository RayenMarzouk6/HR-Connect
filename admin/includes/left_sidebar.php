<div class="left-side-bar">
		<div class="brand-logo">
			<a href="admin_dashboard.php">
				<img src="../vendors/images/layout/logo.png" alt="" class="dark-logo" width="750">
				<img src="../vendors/images/layout/logo.png" alt="" class="light-logo" width="750">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-apartment"></span><span class="mtext"> employees History </span>
						</a>
						<ul class="submenu">
